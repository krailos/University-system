...
class YearServiceTest {
	...
	return Year.builder().id(1).name("year").speciality(Specialty.builder().id(1).build()).build();
    }

    private List<Year> createYears() {
	return new ArrayList<>(
		Arrays.asList(Year.builder().id(1).name("year").speciality(Specialty.builder().id(1).build()).build(),
			Year.builder().id(2).name("year2").speciality(Specialty.builder().id(1).build()).build()));
    }
